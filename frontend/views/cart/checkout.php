            ...
            <div class="card-body">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td class="product-total"> <strong class="product-quantity"><?php echo $productQuantity ?></td>
                        </strong>
                    </tr>
                    <tr>
                    <tr class="order-total">
                        <th>Total Price</th>
                        <td>
                            <strong><span class="amount"> <?php echo Yii::$app->formatter->asCurrency($totalPrice) ?></span></strong>
                        </td>
                    </tr>
                    </tr>
                </table>
